...
class LSTM_Attention(torch.nn.Module):
    def __init__(self, voc_size, vec_dim=100, hid_dim=200, att_dim=100, n_layers=2, drop_prob=0.5, bidirectional=True):
        ...
        self.dis_linear = torch.nn.Linear(self.hid_dim * self.num_dir, 1)
